...
const CashWithdrawalModal = ({ visible, onClose, onSave }) => {
  ...
  const handleSave = async () => {
    ...
    // Create a cash withdrawal entry
    // This will debit from UPI and credit to cash
    const entryData = {
      amount: parsedAmount,
          ...
          >
            {(!amount || parseFloat(amount) <= 0) ? (
              <View style={[styles.saveButton, styles.saveButtonDisabled]}>
                <Text style={styles.saveButtonTextDisabled}>Withdraw Cash</Text>
              </View>
            ) : (
              <LinearGradient
              ...
              >
                ...
                <Text style={styles.saveButtonText}>Withdraw Cash</Text>
              </LinearGradient>
            )}
          </TouchableOpacity>
        </View>
