...
export const exportToExcel = async (entries, options = {}) => {
  try {
    ...
    let csvContent = '═══════════════════════════════════════════════════════════════════════════════\n';
    csvContent += 'SPENDORBIT EXPENSE TRACKER - EXPORT REPORT\n';
    csvContent += '═══════════════════════════════════════════════════════════════════════════════\n';
    csvContent += '\n';
    ...
    csvContent += `Expense - Digital,,${expenseUpi.toFixed(2)},,\n`;
    csvContent += `Expense - Cash,,${expenseCash.toFixed(2)},,\n`;
    csvContent += `Income - Digital,,${incomeUpi.toFixed(2)},,\n`;
    ...
    csvContent += '═══════════════════════════════════════════════════════════════════════════════\n';
    csvContent += 'This report was generated by SpendOrbit Expense Tracker App\n';
    ...
    let fileName = `spendorbit-expense-tracker-app-${typeLabel}-report`;
...
export const exportToJSON = async (entries, options = {}) => {
  try {
    ...
    const jsonExport = {
      metadata: {
        generatedBy: 'SpendOrbit Expense Tracker App',
      ...
      data: entries,
      advertisement: {
        message: 'This report was generated by SpendOrbit Expense Tracker App.',
        services: [
